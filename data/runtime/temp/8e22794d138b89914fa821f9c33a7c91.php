<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:44:"./application/admin/template/product\add.htm";i:1575715763;s:78:"D:\phpstudy_pro\WWW\bendi.web.com\application\admin\template\public\layout.htm";i:1571728724;s:83:"D:\phpstudy_pro\WWW\bendi.web.com\application\admin\template\field\addonextitem.htm";i:1573695224;s:91:"D:\phpstudy_pro\WWW\bendi.web.com\application\admin\template\diy_extend\archives_extend.htm";i:1571728724;s:78:"D:\phpstudy_pro\WWW\bendi.web.com\application\admin\template\public\footer.htm";i:1571728724;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page" style="min-width:auto;box-shadow:none;">
    ...
    <form class="form-horizontal" id="post_form" action="<?php echo url('Product/add'); ?>" method="post">
        ...
        <?php endif; if(1 == $shopConfig['shop_open'] && !empty($ifcontrolRow['users_price'])): if(empty($shopConfig['shop_open_spec'])): ?>
                <input type="hidden" name="stock_count" value="99999">
            <?php else: ?>
                <dl class="row">
                    <dt class="tit">
