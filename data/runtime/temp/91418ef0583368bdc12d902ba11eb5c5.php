<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:44:"./application/admin/template/weapp\index.htm";i:1576153854;s:78:"D:\phpstudy_pro\WWW\bendi.web.com\application\admin\template\public\layout.htm";i:1571728724;s:78:"D:\phpstudy_pro\WWW\bendi.web.com\application\admin\template\public\footer.htm";i:1571728724;}*/ ?>
<!doctype html>
<html>
<head>
                            ...
                            <td>
                                ...
                                <?php if(empty($vo['status']) || (($vo['status'] instanceof \think\Collection || $vo['status'] instanceof \think\Paginator ) && $vo['status']->isEmpty())): if(is_check_access('Weapp@install') == '1'): ?>
                                    ...
                                    <?php endif; else: if(is_check_access('Weapp@execute') == '1'): if(!isset($vo['config']['management_index']) || empty($vo['config']['management_index'])): ?>
                                        ...
                                        <?php endif; endif; if(is_check_access('Weapp@uninstall') == '1'): if($isFounder == '1'): ?>
        ...
        <div class="tDiv">
            <div class="tDiv2">
                ...
                <div class="fbutton">
                    ...
                    <input type="hidden" id="is_weapp_installanswer" value="<?php echo (isset($is_weapp_installanswer) && ($is_weapp_installanswer !== '')?$is_weapp_installanswer:'0'); ?>" />
                    <?php else: ?>
...
<script>
    $(document).ready(function(){
        ...
        <?php if(empty($is_set_weapp_answer) || (($is_set_weapp_answer instanceof \think\Collection || $is_set_weapp_answer instanceof \think\Paginator ) && $is_set_weapp_answer->isEmpty())): ?>
        get_setting();
        <?php endif; ?>

        $('#weappfile').change(function(){
            <?php if(empty($weapp_install_answer) || (($weapp_install_answer instanceof \think\Collection || $weapp_install_answer instanceof \think\Paginator ) && $weapp_install_answer->isEmpty())): ?>
            get_setting();
            return false;
            <?php endif; ?>
            ...
            if (0 == is_weapp_installanswer) {
                layer.prompt({
                        ...
                        success: function(layero, index){
                            $("#input_installanswer").prepend('<div style="margin-bottom: 15px;font-size: 14px;color: red;font-weight: bold;"><?php echo $weapp_install_asktitle; ?></div>');
        ...
        function get_setting()
        {
            ...
            var iframes = layer.open({
                ...
                shade: 0.3,
                area: ['500px', '330px'],
                content: "<?php echo url('Weapp/setting'); ?>",
                end: function(){
                    $.ajax({
                        type : 'get',
                        url : "<?php echo url('Weapp/setting_close'); ?>",
                        data : {_ajax:1},
                        dataType : 'json',
    ...
    function uninstall_true(answer, obj)
    {
        ...
        $.ajax({
            type : 'post',
            url : "<?php echo url('Weapp/uninstall', ['_ajax'=>1]); ?>",
